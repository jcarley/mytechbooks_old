...
book = Book.create! title: 'Service-Oriented Design with Ruby and Rails', ean: '9780321659361', isbn: '0321659368', pages: 250, binding: 'Paperback',
  ...
  publisher: 'Addison-Wesley Professional', published_on: '2012-12-16'
user.books << book
user.save
