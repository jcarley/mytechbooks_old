...
user = User.new(first_name: 'Jefferson', last_name: 'Carley').tap do |user|
  user.email = 'jcarley@example.com'
...
# book = Book.create! title: 'Service-Oriented Design with Ruby and Rails', author: 'Paul Dix', ean: '9780321659361', isbn: '0321659368', pages: 250, binding: 'Paperback',
  # edition: 1, formatted_price: '$49.99', asin: '0321659368', amount: '4999', details_url: 'http://www.amazon.com/Service-Oriented-Design-Addison-Wesley-Professional-Series/dp/0321659368%3FSubscriptionId%3D12VVZFFGCXXK8A0B40G2%26tag%3Dwwwjefferso02-20%26linkCode%3Dxm2%26camp%3D2025%26creative%3D165953%26creativeASIN%3D0321659368',
...
user = User.new(first_name: 'Jaden', last_name: 'Carley').tap do |user|
  user.email = 'jaden@example.com'
  user.password = 'password'
end
puts "User saved? #{user.save}"
puts 'New user created: ' << user.email
